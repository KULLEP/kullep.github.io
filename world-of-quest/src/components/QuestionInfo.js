...
const QuestionInfo = ({activeQuestNum}) => {
	...
	var name = window.infoUser.jsonInfoGame.teams[team_player].name; // Назание команды
	var captain = window.infoUser.jsonInfoGame.teams[team_player].captain; // Капитан
	// var players = window.infoUser.jsonInfoGame.questions[team_player].players.length; // Игроки
	var mistakes = window.infoUser.jsonInfoGame.teams[team_player].mistakes; // Ошибки
